...
#include "vmulcaddc-microkernel-tester.h"
  ...
  TEST(F32_VMULCADDC_MINMAX_C4__SSE_2X, channels_eq_4) {
    ...
    VMulCAddCMicrokernelTester()
      ...
      .channels(4)
      .rows(2)
      .Test(xnn_f32_vmulcaddc_minmax_ukernel_c4__sse_2x, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VMULCADDC_MINMAX_C8__SSE_2X, channels_eq_8) {
    ...
    VMulCAddCMicrokernelTester()
      ...
      .channels(8)
      .rows(2)
      .Test(xnn_f32_vmulcaddc_minmax_ukernel_c8__sse_2x, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VMULCADDC_MINMAX_C4__WASMSIMD_ARM_2X, channels_eq_4) {
    VMulCAddCMicrokernelTester()
      ...
      .channels(4)
      .rows(2)
      .Test(xnn_f32_vmulcaddc_minmax_ukernel_c4__wasmsimd_arm_2x, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VMULCADDC_MINMAX_C4__WASMSIMD_X86_2X, channels_eq_4) {
    VMulCAddCMicrokernelTester()
      ...
      .channels(4)
      .rows(2)
      .Test(xnn_f32_vmulcaddc_minmax_ukernel_c4__wasmsimd_x86_2x, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VMULCADDC_MINMAX_C8__WASMSIMD_X86_2X, channels_eq_8) {
    VMulCAddCMicrokernelTester()
      ...
      .channels(8)
      .rows(2)
      .Test(xnn_f32_vmulcaddc_minmax_ukernel_c8__wasmsimd_x86_2x, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VMULCADDC_MINMAX_C4__WASMRELAXEDSIMD_FMA_2X, channels_eq_4) {
    VMulCAddCMicrokernelTester()
      ...
      .channels(4)
      .rows(2)
      .Test(xnn_f32_vmulcaddc_minmax_ukernel_c4__wasmrelaxedsimd_fma_2x, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VMULCADDC_MINMAX_C4__WASMRELAXEDSIMD_2X, channels_eq_4) {
    VMulCAddCMicrokernelTester()
      ...
      .channels(4)
      .rows(2)
      .Test(xnn_f32_vmulcaddc_minmax_ukernel_c4__wasmrelaxedsimd_2x, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VMULCADDC_MINMAX_C8__WASMRELAXEDSIMD_2X, channels_eq_8) {
    VMulCAddCMicrokernelTester()
      ...
      .channels(8)
      .rows(2)
      .Test(xnn_f32_vmulcaddc_minmax_ukernel_c8__wasmrelaxedsimd_2x, xnn_init_f32_minmax_scalar_params);
  }
  ...
  TEST(F32_VMULCADDC_MINMAX_C8__RVV_2X, channels_eq_8) {
    TEST_REQUIRES_RISCV_VECTOR;
    VMulCAddCMicrokernelTester()
      .channel_tile(8)
      .channels(8)
      .rows(2)
      .Test(xnn_f32_vmulcaddc_minmax_ukernel_c8__rvv_2x, xnn_init_f32_minmax_scalar_params);
  }

  TEST(F32_VMULCADDC_MINMAX_C8__RVV_2X, channels_div_8) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t channels = 16; channels < 80; channels += 8) {
      VMulCAddCMicrokernelTester()
        .channel_tile(8)
  ...
  TEST(F32_VMULCADDC_MINMAX_C8__RVV_2X, channels_lt_8) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t channels = 1; channels < 8; channels++) {
      VMulCAddCMicrokernelTester()
        .channel_tile(8)
  ...
  TEST(F32_VMULCADDC_MINMAX_C8__RVV_2X, channels_gt_8) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t channels = 9; channels < 16; channels++) {
      VMulCAddCMicrokernelTester()
        .channel_tile(8)
  ...
  TEST(F32_VMULCADDC_MINMAX_C8__RVV_2X, rows_lt_2) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t rows = 1; rows < 2; rows++) {
      for (size_t channels = 1; channels <= 40; channels += 7) {
        VMulCAddCMicrokernelTester()
  ...
  TEST(F32_VMULCADDC_MINMAX_C8__RVV_2X, rows_div_2) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t rows = 4; rows <= 8; rows += 2) {
      for (size_t channels = 1; channels <= 40; channels += 7) {
        VMulCAddCMicrokernelTester()
  ...
  TEST(F32_VMULCADDC_MINMAX_C8__RVV_2X, rows_gt_2) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t rows = 3; rows < 4; rows++) {
      for (size_t channels = 1; channels <= 40; channels += 7) {
        VMulCAddCMicrokernelTester()
  ...
  TEST(F32_VMULCADDC_MINMAX_C8__RVV_2X, input_stride) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t rows = 1; rows <= 6; rows += 1) {
      for (size_t channels = 1; channels <= 40; channels += 7) {
        VMulCAddCMicrokernelTester()
  ...
  TEST(F32_VMULCADDC_MINMAX_C8__RVV_2X, output_stride) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t rows = 1; rows <= 6; rows += 1) {
      for (size_t channels = 1; channels <= 40; channels += 7) {
        VMulCAddCMicrokernelTester()
  ...
  TEST(F32_VMULCADDC_MINMAX_C8__RVV_2X, inplace) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t rows = 1; rows <= 6; rows += 1) {
      for (size_t channels = 1; channels <= 40; channels += 7) {
        VMulCAddCMicrokernelTester()
  ...
  TEST(F32_VMULCADDC_MINMAX_C8__RVV_2X, qmin) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t rows = 1; rows <= 6; rows += 1) {
      for (size_t channels = 1; channels <= 40; channels += 7) {
        VMulCAddCMicrokernelTester()
  ...
  TEST(F32_VMULCADDC_MINMAX_C8__RVV_2X, qmax) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t rows = 1; rows <= 6; rows += 1) {
      for (size_t channels = 1; channels <= 40; channels += 7) {
        VMulCAddCMicrokernelTester()
...
#if XNN_ENABLE_RISCV_VECTOR && XNN_ARCH_RISCV
  TEST(F32_VMULCADDC_MINMAX_C4__RVV_2X, channels_eq_4) {
    TEST_REQUIRES_RISCV_VECTOR;
    VMulCAddCMicrokernelTester()
      .channel_tile(4)
      .channels(4)
      .rows(2)
      .Test(xnn_f32_vmulcaddc_minmax_ukernel_c4__rvv_2x, xnn_init_f32_minmax_scalar_params);
  }

  TEST(F32_VMULCADDC_MINMAX_C4__RVV_2X, channels_div_4) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t channels = 8; channels < 40; channels += 4) {
      VMulCAddCMicrokernelTester()
        .channel_tile(4)
  ...
  TEST(F32_VMULCADDC_MINMAX_C4__RVV_2X, channels_lt_4) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t channels = 1; channels < 4; channels++) {
      VMulCAddCMicrokernelTester()
        .channel_tile(4)
  ...
  TEST(F32_VMULCADDC_MINMAX_C4__RVV_2X, channels_gt_4) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t channels = 5; channels < 8; channels++) {
      VMulCAddCMicrokernelTester()
        .channel_tile(4)
  ...
  TEST(F32_VMULCADDC_MINMAX_C4__RVV_2X, rows_lt_2) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t rows = 1; rows < 2; rows++) {
      for (size_t channels = 1; channels <= 20; channels += 3) {
        VMulCAddCMicrokernelTester()
  ...
  TEST(F32_VMULCADDC_MINMAX_C4__RVV_2X, rows_div_2) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t rows = 4; rows <= 8; rows += 2) {
      for (size_t channels = 1; channels <= 20; channels += 3) {
        VMulCAddCMicrokernelTester()
  ...
  TEST(F32_VMULCADDC_MINMAX_C4__RVV_2X, rows_gt_2) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t rows = 3; rows < 4; rows++) {
      for (size_t channels = 1; channels <= 20; channels += 3) {
        VMulCAddCMicrokernelTester()
  ...
  TEST(F32_VMULCADDC_MINMAX_C4__RVV_2X, input_stride) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t rows = 1; rows <= 6; rows += 1) {
      for (size_t channels = 1; channels <= 20; channels += 3) {
        VMulCAddCMicrokernelTester()
  ...
  TEST(F32_VMULCADDC_MINMAX_C4__RVV_2X, output_stride) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t rows = 1; rows <= 6; rows += 1) {
      for (size_t channels = 1; channels <= 20; channels += 3) {
        VMulCAddCMicrokernelTester()
  ...
  TEST(F32_VMULCADDC_MINMAX_C4__RVV_2X, inplace) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t rows = 1; rows <= 6; rows += 1) {
      for (size_t channels = 1; channels <= 20; channels += 3) {
        VMulCAddCMicrokernelTester()
  ...
  TEST(F32_VMULCADDC_MINMAX_C4__RVV_2X, qmin) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t rows = 1; rows <= 6; rows += 1) {
      for (size_t channels = 1; channels <= 20; channels += 3) {
        VMulCAddCMicrokernelTester()
  ...
  TEST(F32_VMULCADDC_MINMAX_C4__RVV_2X, qmax) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t rows = 1; rows <= 6; rows += 1) {
      for (size_t channels = 1; channels <= 20; channels += 3) {
        VMulCAddCMicrokernelTester()
