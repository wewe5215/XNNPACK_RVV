...
void xnn_f32_igemm_minmax_ukernel_7x1v__rvv(
    size_t mr,
    size_t nc,
    size_t kc,
    size_t ks,
    ...
    const union xnn_f32_minmax_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    vfloat32m1_t vacc4 =  __riscv_vmv_v_v_f32m1(vacc0, vl);
    vfloat32m1_t vacc5 =  __riscv_vmv_v_v_f32m1(vacc0, vl);
    vfloat32m1_t vacc6 =  __riscv_vmv_v_v_f32m1(vacc0, vl);
    ...
    do {
      ...
      do {
        ...
        vacc4 = __riscv_vfmacc_vf_f32m1(vacc4, va4, vb, vl);
        vacc5 = __riscv_vfmacc_vf_f32m1(vacc5, va5, vb, vl);
        vacc6 = __riscv_vfmacc_vf_f32m1(vacc6, va6, vb, vl);
