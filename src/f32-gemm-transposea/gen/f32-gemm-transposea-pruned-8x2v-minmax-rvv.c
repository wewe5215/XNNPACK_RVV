...
void xnn_f32_transpose_a_pruned_gemm_minmax_ukernel_8x2v__rvv(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const union xnn_f32_minmax_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  const float* w7 = (const float*) ((uintptr_t) w6 + w_stride);
  float* c7 = (float*) ((uintptr_t) c6 + cm_stride);
  const float* bias7 = (const float*) ((uintptr_t)bias6 + sizeof(float));
  ...
  do {
    ...
    vfloat32m2_t vacc1 =  __riscv_vfmv_v_f_f32m2(*bias1, vl);
    vfloat32m2_t vacc2 =  __riscv_vfmv_v_f_f32m2(*bias2, vl);
    vfloat32m2_t vacc3 =  __riscv_vfmv_v_f_f32m2(*bias3, vl);
    vfloat32m2_t vacc4 =  __riscv_vfmv_v_f_f32m2(*bias4, vl);
    vfloat32m2_t vacc5 =  __riscv_vfmv_v_f_f32m2(*bias5, vl);
    ...
    do {
      ...
      vacc1 = __riscv_vfmacc_vf_f32m2(vacc1, vw1, vb, vl);
      vacc2 = __riscv_vfmacc_vf_f32m2(vacc2, vw2, vb, vl);
      vacc3 = __riscv_vfmacc_vf_f32m2(vacc3, vw3, vb, vl);
      vacc4 = __riscv_vfmacc_vf_f32m2(vacc4, vw4, vb, vl);
      vacc5 = __riscv_vfmacc_vf_f32m2(vacc5, vw5, vb, vl);
      vacc6 = __riscv_vfmacc_vf_f32m2(vacc6, vw6, vb, vl);
      vacc7 = __riscv_vfmacc_vf_f32m2(vacc7, vw7, vb, vl);
      k -= sizeof(float);
    } while (k != 0);
    ...
    vacc4 = __riscv_vfmax_vf_f32m2(vacc4, vmin, vl);
    vacc5 = __riscv_vfmax_vf_f32m2(vacc5, vmin, vl);
    vacc6 = __riscv_vfmax_vf_f32m2(vacc6, vmin, vl);
    vacc7 = __riscv_vfmax_vf_f32m2(vacc7, vmin, vl);
    ...
    vacc4 = __riscv_vfmin_vf_f32m2(vacc4, vmax, vl);
    vacc5 = __riscv_vfmin_vf_f32m2(vacc5, vmax, vl);
    vacc6 = __riscv_vfmin_vf_f32m2(vacc6, vmax, vl);
    vacc7 = __riscv_vfmin_vf_f32m2(vacc7, vmax, vl);
    ...
    __riscv_vse32_v_f32m2(c4, vacc4, vl);
    c4 = (float*) ((uintptr_t) c4 + cn_stride);
    __riscv_vse32_v_f32m2(c5, vacc5, vl);
    c5 = (float*) ((uintptr_t) c5 + cn_stride);
    __riscv_vse32_v_f32m2(c6, vacc6, vl);
