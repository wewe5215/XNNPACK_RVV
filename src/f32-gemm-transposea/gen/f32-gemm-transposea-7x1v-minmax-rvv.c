...
void xnn_f32_transpose_a_gemm_minmax_ukernel_7x1v__rvv(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const union xnn_f32_minmax_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    vfloat32m1_t vacc0 =  __riscv_vmv_v_v_f32m1(bias0, vl);
    vfloat32m1_t vacc1 =  __riscv_vmv_v_v_f32m1(bias1, vl);
    vfloat32m1_t vacc2 =  __riscv_vmv_v_v_f32m1(bias2, vl);
    vfloat32m1_t vacc3 =  __riscv_vmv_v_v_f32m1(bias3, vl);
    vfloat32m1_t vacc4 =  __riscv_vmv_v_v_f32m1(bias4, vl);
    vfloat32m1_t vacc5 =  __riscv_vmv_v_v_f32m1(bias5, vl);
    vfloat32m1_t vacc6 =  __riscv_vmv_v_v_f32m1(bias6, vl);
    ...
    do {
      ...
      const float vw5 = *w5++;
      const float vw6 = *w6++;
      vfloat32m1_t vb = __riscv_vle32_v_f32m1(a, vl);
      a = a + nr;
      vacc0 = __riscv_vfmacc_vf_f32m1(vacc0, vw0, vb, vl);
      vacc1 = __riscv_vfmacc_vf_f32m1(vacc1, vw1, vb, vl);
      vacc2 = __riscv_vfmacc_vf_f32m1(vacc2, vw2, vb, vl);
      vacc3 = __riscv_vfmacc_vf_f32m1(vacc3, vw3, vb, vl);
      vacc4 = __riscv_vfmacc_vf_f32m1(vacc4, vw4, vb, vl);
      vacc5 = __riscv_vfmacc_vf_f32m1(vacc5, vw5, vb, vl);
      vacc6 = __riscv_vfmacc_vf_f32m1(vacc6, vw6, vb, vl);
      k -= sizeof(float);
    } while (k != 0);
    ...
    vacc4 = __riscv_vfmax_vf_f32m1(vacc4, vmin, vl);
    vacc5 = __riscv_vfmax_vf_f32m1(vacc5, vmin, vl);
    vacc6 = __riscv_vfmax_vf_f32m1(vacc6, vmin, vl);
    ...
    vacc4 = __riscv_vfmin_vf_f32m1(vacc4, vmax, vl);
    vacc5 = __riscv_vfmin_vf_f32m1(vacc5, vmax, vl);
    vacc6 = __riscv_vfmin_vf_f32m1(vacc6, vmax, vl);
    ...
    __riscv_vse32_v_f32m1(c4, vacc4, vl);
    c4 = (float*) ((uintptr_t) c4 + cn_stride);
    __riscv_vse32_v_f32m1(c5, vacc5, vl);
    c5 = (float*) ((uintptr_t) c5 + cn_stride);
    __riscv_vse32_v_f32m1(c6, vacc6, vl);
