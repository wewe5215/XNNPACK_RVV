...
void xnn_f32_transpose_a_gemm_minmax_ukernel_7x8v__rvv(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const union xnn_f32_minmax_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    do {
      ...
      const float vw5 = *w5++;
      const float vw6 = *w6++;
      vfloat32m8_t vb = __riscv_vle32_v_f32m8(a, vl);
      a = a + nr;
      ...
      vacc4 = __riscv_vfmacc_vf_f32m8(vacc4, vw4, vb, vl);
      vacc5 = __riscv_vfmacc_vf_f32m8(vacc5, vw5, vb, vl);
      vacc6 = __riscv_vfmacc_vf_f32m8(vacc6, vw6, vb, vl);
      k -= sizeof(float);
    } while (k != 0);
    ...
    vacc4 = __riscv_vfmax_vf_f32m8(vacc4, vmin, vl);
    vacc5 = __riscv_vfmax_vf_f32m8(vacc5, vmin, vl);
    vacc6 = __riscv_vfmax_vf_f32m8(vacc6, vmin, vl);

    vacc0 = __riscv_vfmin_vf_f32m8(vacc0, vmax, vl);
    vacc1 = __riscv_vfmin_vf_f32m8(vacc1, vmax, vl);
    vacc2 = __riscv_vfmin_vf_f32m8(vacc2, vmax, vl);
    vacc3 = __riscv_vfmin_vf_f32m8(vacc3, vmax, vl);
    vacc4 = __riscv_vfmin_vf_f32m8(vacc4, vmax, vl);
    vacc5 = __riscv_vfmin_vf_f32m8(vacc5, vmax, vl);
    vacc6 = __riscv_vfmin_vf_f32m8(vacc6, vmax, vl);
    ...
    __riscv_vse32_v_f32m8(c4, vacc4, vl);
    c4 = (float*) ((uintptr_t) c4 + cn_stride);
    __riscv_vse32_v_f32m8(c5, vacc5, vl);
    c5 = (float*) ((uintptr_t) c5 + cn_stride);
    __riscv_vse32_v_f32m8(c6, vacc6, vl);
